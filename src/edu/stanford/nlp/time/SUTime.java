...
public class SUTime {
  ...
  public static final Time TIME_NOW = new RefTime("NOW") {
    public TimeLabel getTimeLabel() {
      return TimeLabel.NOW;
    }
  };
  public static final Time TIME_PRESENT = new InexactTime(new Range(TIME_NOW, TIME_NOW)) {
    public TimeLabel getTimeLabel() {
      return TimeLabel.PRESENT;
    }
  };
  public static final Time TIME_PAST = new InexactTime(new Range(TIME_UNKNOWN, TIME_NOW)) {
    public TimeLabel getTimeLabel() {
      return TimeLabel.PAST;
    }
  };
  public static final Time TIME_FUTURE = new InexactTime(new Range(TIME_NOW, TIME_UNKNOWN)) {
    public TimeLabel getTimeLabel() {
  ...
  public static final Time WEEKDAY = new InexactTime(null, SUTime.DAY, new SUTime.Range(SUTime.MONDAY, SUTime.FRIDAY)) {
    public TimeLabel getTimeLabel() {
      return TimeLabel.WEEKDAY;
    }
  };
  public static final Time WEEKEND = new TimeWithRange(new SUTime.Range(SUTime.SATURDAY, SUTime.SUNDAY, SUTime.DAY.multiplyBy(2))) {
    public TimeLabel getTimeLabel() {
  ...
  public static final Time SPRING_EQUINOX = new SUTime.InexactTime(new SUTime.Range(new IsoDate(-1, 3, 20), new IsoDate(-1, 3, 21))) {
    public TimeLabel getTimeLabel() {
      return TimeLabel.SPRING_EQUINOX;
    }
  };
  public static final Time SUMMER_SOLSTICE = new SUTime.InexactTime(new SUTime.Range(new IsoDate(-1, 6, 20), new IsoDate(-1, 6, 21))) {
    public TimeLabel getTimeLabel() {
      return TimeLabel.SUMMER_SOLSTICE;
    }
  };
  public static final Time WINTER_SOLSTICE = new SUTime.InexactTime(new SUTime.Range(new IsoDate(-1, 12, 21), new IsoDate(-1, 12, 22))) {
    public TimeLabel getTimeLabel() {
      return TimeLabel.WINTER_SOLSTICE;
    }
  };
  public static final Time FALL_EQUINOX = new SUTime.InexactTime(new SUTime.Range(new IsoDate(-1, 9, 22), new IsoDate(-1, 9, 23))) {
    public TimeLabel getTimeLabel() {
  ...
  public static final Time DAYTIME = new InexactTime(new Range(SUNRISE, SUNSET)) {
    public TimeLabel getTimeLabel() {
  ...
  public static enum TimeLabel {
    MORNING(TIME_OF_DAY, "MO", SUTime.MORNING),
    TEATIME(TIME_OF_DAY, "AF", SUTime.TEATIME),
    LUNCHTIME(TIME_OF_DAY, "MI", SUTime.LUNCHTIME),
    DINNERTIME(TIME_OF_DAY, "EV", SUTime.DINNERTIME),
    NOON(TIME_OF_DAY, null, SUTime.NOON),
    AFTERNOON(TIME_OF_DAY, "AF", SUTime.AFTERNOON),
    EVENING(TIME_OF_DAY, "EV", SUTime.EVENING),
    MIDNIGHT(TIME_OF_DAY, null, SUTime.MIDNIGHT),
    DAWN(TIME_OF_DAY, "MO", SUTime.DAWN) {
    ...
    DAYTIME(TIME_OF_DAY, "DT", SUTime.DAYTIME),
    SUNSET(TIME_OF_DAY, "EV", SUTime.SUNSET) {
      public String getModifier() {
        return SUTime.TimexMod.EARLY.name();
      }
    },
    EVENING_TWILIGHT(TIME_OF_DAY, "EV", SUTime.EVENING_TWILIGHT),
    DUSK(TIME_OF_DAY, "EV", SUTime.DUSK),
    NIGHT(TIME_OF_DAY, "NI", SUTime.NIGHT),
    TWILIGHT(TIME_OF_DAY, "NI", SUTime.TWILIGHT),

    YEARS(TimeLabelType.YEAR, null, SUTime.YEAR),
    QUARTERS(TimeLabelType.QUARTER, null, SUTime.QUARTER),
    MONTHS(TimeLabelType.MONTH, null, SUTime.MONTH),
    WEEKS(TimeLabelType.WEEK,null, SUTime.WEEK),
    DAYS(TimeLabelType.DAY, null, SUTime.DAY),
    HOURS(TimeLabelType.HOUR, null, SUTime.HOUR),
    MINUTES(TimeLabelType.MINUTE, null, SUTime.MINUTE),
    SECONDS(TimeLabelType.SECOND, null, SUTime.SECOND),
    MILLIS(TimeLabelType.MILLIS, null, SUTime.MILLIS),

    MONDAY(DAY_OF_WEEK, null, SUTime.MONDAY),
    TUESDAY(DAY_OF_WEEK, null, SUTime.TUESDAY),
    WEDNESDAY(DAY_OF_WEEK, null, SUTime.WEDNESDAY),
    THURSDAY(DAY_OF_WEEK, null, SUTime.THURSDAY),
    FRIDAY(DAY_OF_WEEK, null, SUTime.FRIDAY),
    SATURDAY(DAY_OF_WEEK, null, SUTime.SATURDAY),
    SUNDAY(DAY_OF_WEEK, null, SUTime.SUNDAY),

    JANUARY(MONTH_OF_YEAR, null, SUTime.JANUARY),
    FEBRUARY(MONTH_OF_YEAR, null, SUTime.FEBRUARY),
    MARCH(MONTH_OF_YEAR, null, SUTime.MARCH),
    APRIL(MONTH_OF_YEAR, null, SUTime.APRIL),
    MAY(MONTH_OF_YEAR, null, SUTime.MAY),
    JUNE(MONTH_OF_YEAR, null, SUTime.JUNE),
    JULY(MONTH_OF_YEAR, null, SUTime.JULY),
    AUGUST(MONTH_OF_YEAR, null, SUTime.AUGUST),
    SEPTEMBER(MONTH_OF_YEAR, null, SUTime.SEPTEMBER),
    OCTOBER(MONTH_OF_YEAR, null, SUTime.OCTOBER),
    NOVEMBER(MONTH_OF_YEAR, null, SUTime.NOVEMBER),
    DECEMBER(MONTH_OF_YEAR, null, SUTime.DECEMBER),

    WEEKDAY(DAYS_OF_WEEK, "WD", SUTime.WEEKDAY) {
      public Duration getDuration() {
        return SUTime.DAY; //temporal.getDuration();
      }
    },
    WEEKEND(DAYS_OF_WEEK, "WE", SUTime.WEEKEND) {
      public Duration getDuration() {
        return SUTime.DAY.multiplyBy(2); //temporal.getDuration();
      }
    },

    SPRING(SEASON_OF_YEAR, "SP", SUTime.SPRING),
    SUMMER(SEASON_OF_YEAR, "SU", SUTime.SUMMER),
    WINTER(SEASON_OF_YEAR, "WI", SUTime.WINTER),
    FALL(SEASON_OF_YEAR, "FA", SUTime.FALL),

    NOW(REFTIME, "PRESENT_REF", SUTime.TIME_REF),
    PAST(REFDATE, "PAST_REF", SUTime.TIME_PAST),
    PRESENT(REFDATE, "PRESENT_REF", SUTime.TIME_PRESENT),
    FUTURE(REFDATE, "FUTURE_REF", SUTime.TIME_FUTURE),

    // Dates are rough with respect to northern hemisphere (actual
    // solstice/equinox days depend on the year)
    SPRING_EQUINOX(TimeLabelType.DAY, "SP", SUTime.SPRING_EQUINOX),
    SUMMER_SOLSTICE(TimeLabelType.DAY, "SU", SUTime.SUMMER_SOLSTICE),
    WINTER_SOLSTICE(TimeLabelType.DAY, "WI", SUTime.WINTER_SOLSTICE),
    FALL_EQUINOX(TimeLabelType.DAY, "FA", SUTime.FALL_EQUINOX);
