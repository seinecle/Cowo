...
public class Maps {
   ...
   */
  public static <K extends Comparable<K>, V> List<Map.Entry<K, V>> sortedEntries(Map<K, V> map) {
    List<Entry<K,V>> entriesList = new ArrayList<Map.Entry<K, V>>(map.entrySet());
